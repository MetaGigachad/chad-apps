  ...
  return (
    <div class="flex md:relative" use:clickOutside={() => setShowDropdown(false)}>
      ...
      <Show when={showDropdown()}>
        <div class="md:absolute md:left-1/2 md:top-full m-auto flex md:-translate-x-1/2 md:translate-y-1 items-center gap-2 rounded-lg dark:bg-zinc-600 md:dark:bg-zinc-900 p-1 pl-2">
          <DynamicWidthInput
